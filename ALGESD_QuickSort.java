...
public class ALGESD_QuickSort {
   ...
   static void EXEC_quickSort() {
      ...
      JOptionPane.showMessageDialog(null, "--QUICK SORT--"
         ...
         + "\n\nSeu vetor D original: " + doubleVectorToString(vetorDOriginal) + "\nSeu vetor D ordenado: " + doubleVectorToString(vetorD));
   }
   ...
   static void quickSort_Desc(double[] iVet, int iBaixo, int iAlto) {
      int iP, iB, iA;
      double iPivot;
      ...
      iBaixo=iB;
      iAlto=iA;
      if (iBaixo < iP) quickSort_Desc(iVet, iBaixo, iP-1);
      if (iAlto > iP) quickSort_Desc(iVet, iP+1, iAlto);
   }
