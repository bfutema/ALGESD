...
import model.LSEModelEx23;
import model.LSEModelEx23.Node;
import view.LSEViewEx23;

public class LSEControllerEx23 {
	private static LSEModelEx23 lista;
	private static LSEViewEx23	dspMs;
	
	private static String sAuthor = "Bruno Amaral Futema";
	private static String sRA = "81820360";
	
	private static String sTitle = "ALGESD: Lista Singularmente Encadeada, Exerc'icio 23 (Pilha)";
	...
	public static void main(String[] args) {
		lista = new LSEModelEx23();
		dspMs = new LSEViewEx23();
